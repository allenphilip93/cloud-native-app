package com.cloudnative.services.reviews.rest;

import com.cloudnative.services.reviews.mapper.Mapper;
import com.cloudnative.services.reviews.model.EntityPOJO;
import com.cloudnative.services.reviews.rest.dto.CreateDto;
import com.cloudnative.services.reviews.service.ApiService;
...
public class ApiController {
    ...
    public List<EntityPOJO> getAll() {
        ...
        log.info("Get all reviews", v("numReturned", entities.size()));
        return entities;
    }

    @GetMapping("/{id}")
    public EntityPOJO get(@PathVariable("id") String id) {
        log.info("Get review", v("id", id));
    ...
    public EntityPOJO create(@Valid @RequestBody CreateDto createProductDto) {
        ...
        log.info("Review created", v("id", entity.getId()));
        return entity;
    }
    ...
    public String delete(@PathVariable("id") String id) {
        ...
        log.info("Review deleted", v("id", entity.getId()));
        return entity.getId();
    }
