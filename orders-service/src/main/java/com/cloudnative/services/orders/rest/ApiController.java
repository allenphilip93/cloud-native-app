package com.cloudnative.services.orders.rest;

import com.cloudnative.services.orders.mapper.Mapper;
import com.cloudnative.services.orders.model.EntityPOJO;
import com.cloudnative.services.orders.rest.dto.CreateDto;
import com.cloudnative.services.orders.service.ApiService;
...
public class ApiController {
    ...
    public List<EntityPOJO> getAll() {
        ...
        log.info("Get all orders", v("numReturned", entities.size()));
        return entities;
    }

    @GetMapping("/{id}")
    public EntityPOJO get(@PathVariable("id") String id) {
        log.info("Get order", v("id", id));
    ...
    public EntityPOJO create(@Valid @RequestBody CreateDto createProductDto) {
        ...
        log.info("Order created", v("id", entity.getId()));
        return entity;
    }
    ...
    public String delete(@PathVariable("id") String id) {
        ...
        log.info("Order deleted", v("id", entity.getId()));
        return entity.getId();
    }
